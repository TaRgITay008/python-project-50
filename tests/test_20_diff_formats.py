...
def test_stylish_format():
    ...
    # Проверяем характерные особенности stylish формата
...
def test_plain_format():
    ...
    assert isinstance(result, str)
    # Проверяем характерные особенности plain формата
...
def test_json_format():
    ...
    assert isinstance(result, str)
    # Проверяем характерные особенности json формата
    assert result.startswith('[')
    assert result.endswith(']\n')
...
def test_default_format():
    ...
    # По умолчанию должен использоваться stylish формат
